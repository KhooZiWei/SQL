...
/* ============================================================================== 
   DELETE & TRUNCATE (DELETE can use WHERE as it checks the data row by row (slow and more performance), but TRUNCATE cant use WHERE as it will delete the whole table)
=============================================================================== */
